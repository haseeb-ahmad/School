...
ActiveRecord::Schema.define(:version => 20120816045034) do
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "index_batches_on_is_deleted_and_is_active_and_course_id_and_name", :limit => {"is_deleted"=>nil, "name"=>nil, "is_active"=>nil, "course_id"=>nil}
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"batch_id"=>nil, "observable_type"=>nil, "student_id"=>nil, "exam_id"=>nil, "observable_id"=>nil}
